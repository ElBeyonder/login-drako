...
<script>
    var direcciones = new Array( 'drakopublic/baterias.php', 'drakopublic/fenix.php', 'drakopublic/drakopart.php', 'drakopublic/drakoinfo.php', 'drakopublic/bosch.php', 'drakopublic/roshfrans.php')
