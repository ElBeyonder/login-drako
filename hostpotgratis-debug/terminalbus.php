...
-->
    ...
    <div align="center" class="content">
        ...
        <div class="textopu">
            <h1>ESPERE -->   <span id="countdown"></span> </h1>
        </div>
...
<script>
    var direcciones = new Array( 'drakopublic/baterias.php', 'drakopublic/fenix.php', 'drakopublic/drakopart.php', 'drakopublic/drakoinfo.php', 'terminalbus/passionfish.php', 'terminalbus/publicidad.php', 'terminalbus/computador.php', 'terminalbus/wecfenix.php' )
    function enlaceAleatorio(){
       aleat = Math.random() * direcciones.length
       aleat = Math.floor(aleat)
       url1=String(direcciones[aleat])
       //url1="drakopublic/baterias.php"
